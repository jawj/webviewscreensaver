...
static NSTimeInterval const kDefaultDuration = 60.0 * kOneMinute;
static NSString * const kScreenSaverDefaultURL = @"http://orca.casa.ucl.ac.uk/~george/snow-mo/?credits=0";
